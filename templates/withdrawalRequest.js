exports.withdrawalRequestTemplate = (firstname, lastname, amount) => {
  ...
  <head>
      ...
      <title>Withdrawal Request Successful</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
                ...
                <tr>
                  <td>
                    <div class="text" style="padding: 0 2.5em; text-align: center;">
                      <h2 style="font-size: 28px;"> Dear ${firstname} ${lastname}, twithdrawal request submitted successfully</h2>
                
                      <h3 style="font-size:18px;">Your twithdrawal request of $${amount}
