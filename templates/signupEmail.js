exports.signupEmailTemplate = (firstname, newuser, randomToken) => {
  ...
  <head>
      ...
      <title>Verify Your Email Address</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
                ...
                <tr>
                  <td>
                    <div class="text" style="padding: 0 2.5em; text-align: center;">
                      <h2 style="font-size: 28px;">${firstname} please verify your email</h2>
                      <h3 style="font-size: 18px;">Take your global trading journey a step ahead. Make Investments, Trade Cryptocurrencies with high profit value.</h3>
                      <p><a href="https://paylinesupertrade.herokuapp.com/api/v1/auth/verify/${newuser}/${randomToken}" class="btn btn-primary">Verify Email</a></p>
                
                    </div>
                     <div class="text" style="padding: 0 2.5em; text-align: center;">
                        <p class="payline-text">You can copy and paste the link below on your browser to verify your email address.</p>
                        <p class="paylinelink">https://paylinesupertrade.herokuapp.com/api/v1/auth/verify/${newuser}/${randomToken}</p>
                    </div>
                  </td>
                </tr>
              </table>
