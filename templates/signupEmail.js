                ...
                <tr>
                  <td>
                    <div class="text" style="padding: 0 2.5em; text-align: center;">
                      ...
                      <p><a href="https://wesgroinvestmentltd.herokuapp.com/api/v1/auth/verify/${newuser}/${randomToken}" class="btn btn-primary">Verify Email</a></p>
                
                    </div>
                     <div class="text" style="padding: 0 2.5em; text-align: center;">
                        <p class="payline-text">You can copy and paste the link below on your browser to verify your email address.</p>
                        <p class="paylinelink">https://wesgroinvestmentltd.herokuapp.com/api/v1/auth/verify/${newuser}/${randomToken}</p>
                    </div>
                  </td>
                </tr>
              </table>
