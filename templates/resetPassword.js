exports.resetPasswordTemplate = (firstname, lastname, randToken, userid) => {
  ...
  >
    <head>
      ...
      <title>Verify Reset Your Password</title>
    ...
    <body>
      <div style="width: 100%; margin-top: 30px">
        <div>
          ...
          <p>
            <a
              href="https://www.lunainvestmentgroep.co.za/reset-password?token=${randToken}&id=${userid}"
              target="_blank"
          ...
          <p>
            <a
              href="https://www.lunainvestmentgroep.co.za/reset-password?token=${randToken}&id=${userid}"
            >
              https://www.lunainvestmentgroep.co.za/reset-password?token=${randToken}&id=${userid}</a
            >
          </p>
          ...
          <p>
            ...
            <a href="https://www.lunainvestmentgroep.co.za" target="_blank"></a><br />
            &nbsp;
          </p>
        </div>
      </div>
