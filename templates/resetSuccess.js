exports.resetSuccessTemplate = (firstname, lastname) => {
  ...
  <head>
      ...
      <title>Passwor Reset Successful</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
                ...
                <tr>
                  <td>
                    <div class="text" style="padding: 0 2.5em; text-align: center;">
                      <h2 style="font-size: 17px;"> Hi ${firstname} ${lastname}, password reset was successful</h2>
