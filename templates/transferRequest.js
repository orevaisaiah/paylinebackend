exports.transferRequestTemplate = (firstname, lastname, amount) => {
  return `<!DOCTYPE html>
  ...
  <head>
      ...
      <title>Transfer Request Successful</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
                ...
                <tr>
                  <td>
                    <div class="text" style="padding: 0 2.5em; text-align: center;">
                      <h2 style="font-size: 17px;"> Dear ${firstname} ${lastname}, transfer request submitted successfully</h2>
                
                      <h3 style="font-size:15px;">Your transfer request of $${amount}
