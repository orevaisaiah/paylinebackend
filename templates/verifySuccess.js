                ...
                <tr>
                  <td>
                    <div class="text" style="padding: 0 2.5em; text-align: center;">
                      <h2 style="font-size: 28px;">Welcome ${firstname} ${lastname}, your email address has been verified</h2>
                
                      <h3 style="font-size:18px;">Now take your global trading journey a step ahead. Make Investments, Trade Cryptocurrencies with high profit value.</h3>
                    </div>
                    <div class="text" style="padding: 0 2.5em; text-align: center;">
                    <p
                    class="payline-text"
