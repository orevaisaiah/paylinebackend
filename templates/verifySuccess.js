exports.verifySuccessTemplate = (firstname, lastname) => {
  ...
  <head>
      ...
      <title>Email Verification Successful</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
          ...
          <tr>
            <td valign="middle" class="hero bg_white" style="padding: 2em 0 4em 0;">
              <table>
                <tr>
                  <td>
                    <div class="text" style="padding: 0 2.5em; text-align: center;">
                      <h2 style="font-size: 17px;">Welcome ${firstname} ${lastname}, your email address has been verified</h2>
                
                      <h3 style="font-size:15px;">Now take your global trading journey a step ahead. Make Investments, Trade Cryptocurrencies with high profit value.</h3>
                    </div>
                    <div class="text" style="padding: 0 2.5em; text-align: center;">
                    <p
                    class="payline-text"
                ...
                <p><a href="https://paylinesupertrade.com/login" class="btn btn-primary">Login</a></p>
