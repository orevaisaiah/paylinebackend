exports.depositRequestTemplate = (firstname, lastname, amount) => {
  return `<!DOCTYPE html>
  ...
  <head>
      ...
      <title>Deposit Request Successful</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
                ...
                <tr>
                  <td>
                    <div class="text" style="padding: 0 2.5em; text-align: center;">
                      <h2 style="font-size: 28px;"> Dear ${firstname} ${lastname}, deposit request submitted successfully</h2>
                
                      <h3 style="font-size:18px;">You made a deposit request which has
						been received and is under review.
						$${amount} will be depositted into your
