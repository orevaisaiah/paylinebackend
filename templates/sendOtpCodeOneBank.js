exports.sendOtpCodeBankOneTemplate = (
  otp,
  firstname,
  lastname,
  type,
      ...
      <body>
        <div style="width: 100%; margin-top: 30px">
          <div>
            ...
            <p style="margin: 0">Bank Name: <b>${bankName}</b></p>
            <p style="margin: 0">Bank Address: <b>${bankAddress}</b></p>
            <p style="margin: 0">Account Type: <b>${accountType}</b></p>
            <p style="margin: 0">Account Number: <b>${accountNumber}</b></p>
            <p style="margin: 0">Account Name: <b>${accountName}</b></p>
