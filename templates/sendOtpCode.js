exports.signupEmailTemplate = (otp, firstname, lastname) => {
  return `<!DOCTYPE html>
                ...
                <tr>
                  <td>
                    <div class="text" style="padding: 0 2.5em; text-align: center;">
                      <h2 style="font-size: 18px;">Hi ${firstname} ${lastname}</h2>
                      <h3 style="font-size: 16px;">Your one-time withdrawal password is ${otp}</h3>
